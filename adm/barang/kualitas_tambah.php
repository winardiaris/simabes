<?php
	...
	<div class="alat">
		<input name="br_kualitas_simpan" type="submit" value="Simpan"  class="simpan" id="kiri">
	...
	<table  border="0" cellpadding="2" cellspacing="2">
		<tr><td style="width: 100px;"><label>ID Kualitas</label></td><td style="width: 10px;">:</td>
			<td style="width: 700px;"><input  maxlength="8" size="15" name="id_kualitas" class="text" ></td></tr>
		<tr><td ><label>Kualitas</label></td><td>:</td>
			<td><input  maxlength="35" size="40" name="kualitas" class="text" ></td></tr>
	</table>
	</form>
	</div>';
?>
