<?php
	...
	<div class="alat">
		<input name="br_satuan_simpan" type="submit" value="Simpan" class="simpan" id="kiri">
	...
	<table  border="0" cellpadding="2" cellspacing="2">
		<tr><td style="width: 100px;"><label>ID Satuan</label></td><td style="width: 10px;">:</td>
			<td style="width: 700px;"><input  maxlength="8" size="15" name="id_satuan" class="text"  ></td></tr>
		<tr><td ><label>Satuan</label></td><td>:</td>
			<td><input  maxlength="35" size="40" name="satuan" class="text"></td></tr>
	</table>
	</form>
	</div>';
?>
