...
<?php
	...
	<table cellpadding="5" cellspacing="0" border="0" >
		<tr>
			...
			<td style="width: auto;"><input  maxlength="30" size="40" name="kode_brg" class="text" placeholder="Kode Barang"></td>
		</tr>
		<tr>
			<td ><label>Nama Barang *</label></td>
			<td>:</td>
			<td><input  maxlength="40" size="80" name="nm_brg" class="text" placeholder="Nama Barang"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td><input  maxlength="35" size="40" name="hrg_beli" class="text" id="hrg_beli" placeholder="Harga Beli"></td>
		</tr>
		<tr>
			<td ><label>Harga Jual *</label></td>
			<td>:</td>
			<td>
				<input  maxlength="35" size="40" name="hrg_jual" class="text" id="hrg_jual" placeholder="Harga Jual">
		...
		<tr>
			...
			<td>:</td>
			<td>
				<input  maxlength="35" size="40" name="stok" class="text"  type="number" placeholder="Jumlah Barang"/>
				<label> Stok Minimal : </label>
				<input  maxlength="35" size="40" name="stok_min" class="text"  type="number" placeholder="Stok Minimal"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>:</td>
			<td><input type="text" maxlength="20" size="20" name="tgl_masuk" id="tgl_masuk" class="text" value="'.date("Y-m-d").'"/></td>
		</tr>
		<tr>
			<td valign="top"><label>Keterangan </label></td>
			<td valign="top">:</td>
			<td valign="top"><textarea  cols="80" rows="5" name="ket_brg" placeholder="Keterangan"></textarea></td>
		</tr>
		<tr>
				<td><label>Photo Barang</label></td>
				<td>:</td>
				<td><input type="file" name="photo_brg" id="photo_brg" class="text"></td> 
		</tr>
</table>
</form>
</div>';
