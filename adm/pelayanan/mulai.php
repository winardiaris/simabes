...
// ----- akhir kode otomatis ----- //
	...
	<form class="form1" method="POST" action="?mod='.$_GET['mod'].'&h=aksi" enctype="multipart/form-data"  name="wo" >
	<div class="alat">
	...
	<table class="table" cellpadding="5" cellspacing="0" border="0">
		...
		<tr><td><label>ID Pelanggan *</label></td><td>:</td><td><input list="cari_plg" name="id_plg" class="text" size="30" maxlength="20" placeholder="ID Pelanggan / Nama Pelanggan">
