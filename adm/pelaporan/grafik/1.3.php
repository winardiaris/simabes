...
$qry_kua="SELECT id_satuan, satuan FROM br_satuan";
$kua=mysql_query($qry_kua) or die (mysql_error());
$x_ = "";
$y_ = "";
while($data=mysql_fetch_object($kua)){
	$id_satuan=$data->id_satuan;
		$a = mysql_query(" SELECT COUNT(`id_brg`) AS jml_kua FROM  `br_data` WHERE  `id_satuan`='$id_satuan'");
...
$graph->title->Set("Data Barang per Satuan Barang");
$graph->SetBox(true);
